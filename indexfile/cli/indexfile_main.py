...
@click.option('-f', '--format', envvar=DEFAULT_ENV_FORMAT, type=click.File('r'), default=None, help='Index format specifications in JSON or YAML format.', show_default=True)
